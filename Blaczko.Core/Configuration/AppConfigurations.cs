...
namespace Blaczko.Core.Configuration
{
    public static class AppConfiguration
    {
        ...
        /// <br/>
        /// If a config class inherits from <see cref="ConfigModel"/>, Init() will be called after binding.
        /// </summary>
        /// <typeparam name="T">Config model</typeparam>
        ...
        /// <summary>
        /// Returns the name of the T type, without the Config suffix, if present.
        /// </summary>
        private static string GetConfigSectionNameFromType<T>()
        {
        ...
        /// <summary>
        /// Gets the configuration from the service provider
        /// </summary>
